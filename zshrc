...
# Configuration of ZSH by: pr0c3550r
# Version: 1.35
...
alias desk="xrandr --output HDMI-2 --auto --left-of LVDS-1 && xrandr --output LVDS-1 --off && xrandr --output VGA-1 --auto --right-of HDMI-2 && xwallpaper --output HDMI-2 --maximize ~/Pictures/Wallpaper/see.jpg --output VGA-1 --zoom ~/Pictures/Wallpaper/see.jpg && setxkbmap -layout de,eu -option caps:swapescape -option 'grp:ctrl_alt_toggle'"

# Alias for changing the Output of the XServer to the Laptop Screen and sets the Wallpaper to my prefered one.

alias nodesk="xrandr --output HDMI-2 --off && xrandr --output VGA-1 --off && xrandr --output LVDS-1 --auto && xwallpaper --output LVDS-1 --maximize ~/Pictures/Wallpaper/see.jpg"
alias onlyVGAondesk="xrandr --output LVDS-1 --off && xrandr --output VGA-1 --auto && xwallpaper --output VGA-1 --zoom ~/Pictures/Wallpaper/see.jpg && setxkbmap -layout de,eu -option caps:swapescape -option 'grp:ctrl_alt_toggle'"

# Alias for connecting Monitors on the go and setting the Wallpaper 

alias travel="xrandr --output HDMI-1 --auto --right-of LVDS-1 && xwallpaper --output HDMI-1 --maximize Pictures/Wallpaper/see.jpg --output LVDS-1 --maximize Pictures/Wallpaper/see.jpg" 
alias notravel="xrandr --output HDMI-1 --off"
...
alias key="setxkbmap -layout de,eu -option caps:swapescape -option 'grp:ctrl_alt_toggle'"
